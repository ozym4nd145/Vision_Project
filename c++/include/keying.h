...
Mat get_mask(const Mat& img,param_ycrcb params, double tola=16.0, double tolb=50.0, double low_thresh=0.15, double high_thresh=0.25, double sz=5, double space=200,double alpha=1.0,double beta=0.0,double gamma=1.0);
