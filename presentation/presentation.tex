...
\begin{frame}{Demo 1}
    \begin{columns}
        ...
        % \onslide<+->
        \begin{center}
            \href{run:videos/fight_result.avi}{\includegraphics[scale=0.12]{imgs/fight.png}} 
        \end{center}
        \column{.5\textwidth}
        % \onslide<+->
        \begin{center}
...
\begin{frame}{Demo 2}
    \begin{columns}
        ...
        \onslide<+->\begin{center}
            \href{run:videos/shashank_result.avi}{\includegraphics[scale=0.1]{imgs/demo.png}} 
        \end{center}
        \column{.5\textwidth}
        \onslide<+->\begin{center}
            \href{run:videos/shashank_green.mp4}{\includegraphics[scale=0.2]{imgs/shashank.png}} 
        \end{center}
    \end{columns}   
\end{frame}
